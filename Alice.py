...
def main():
    ...
    print("Send rsa key file to Bob before proceeding!")

    # Wait for encrypted aes
    print("Press enter when you copied encrypted AES key to this folder")
    input()

    # Alice decrypts the AES key using her private key
    aes_key = Alice_get_AES_key(private_key)
